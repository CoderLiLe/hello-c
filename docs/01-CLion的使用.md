...
<img src="assets/01-CLion/01.png" alt="1692692710108" style="zoom:80%;" />
...
1、下载完安装包，双击直接安装![](assets/01-CLion/03.png)

2、欢迎安装

![](assets/01-CLion/04.png)

4、选择安装目录

![](assets/01-CLion/05.png)

选择安装目录，目录中要避免中文和空格。

![](assets/01-CLion/06.png)

5、创建桌面快捷图标等

![](assets/01-CLion/07.png)

确认是否与.c、.h、.cpp格式文件进行关联。这里建议不关联。

6、在【开始】菜单新建一个文件夹（这里需要确认文件夹的名称），来管理CLion的相关内容。

![](assets/01-CLion/08.png)

![](assets/01-CLion/09.png)

7、完成安装

![](assets/01-CLion/10.png)

8、双击打开

![](assets/01-CLion/11.png)

9、选择“Do not import settings”，点击“OK”按钮

<img src="assets/01-CLion/12.png" alt="" style="zoom:80%;" />

10、如图所示，需要激活CLion

<img src="assets/01-CLion/13.png" alt="" style="zoom: 80%;" />

### 2.3 注册

- 选择1：适用30天。在CLion版本中，需要先登录，才能开启试用。

  <img src="assets/01-CLion/14.png" alt="" style="zoom:80%;" />

- 选择2：付费购买旗舰版

  <img src="assets/01-CLion/15.png" alt="" style="zoom:80%;" />

  <img src="assets/01-CLion/16.png" alt="" style="zoom: 67%;" />
...
<img src="assets/01-CLion/17.png" alt="" style="zoom:80%;" />

指定创建C可执行文件、工程目录，图中的“untitled1”需要修改为自己的工程名称。如下所示：

<img src="assets/01-CLion/18.png" alt="" style="zoom:80%;" />

选择C可执行文件，修改工程名称为demo1

<img src="assets/01-CLion/19.png" alt="" style="zoom:80%;" />

点击“Create”进行下一步，如图所示

<img src="assets/01-CLion/20.png" alt="" style="zoom:80%;" />

此处选择编译器，默认MinGW即可，点击“OK”按钮，如图所示，默认创建了main.c文件。

<img src="assets/01-CLion/21-CLion.png" alt="" style="zoom:67%;" />

### 3.2 运行

点击执行按钮，如下所示

<img src="assets/01-CLion/22.png" alt="" style="zoom: 67%;" />



## 4. 详细设置

![](assets/01-CLion/23.png)
...
![](assets/01-CLion/24.png)

#### 2、设置菜单和窗口字体和大小

![](assets/01-CLion/25.png)

### 4.2 设置编辑器主题样式

#### 1、字体大小

![](assets/01-CLion/26.png)

更详细的字体与颜色如下：

![](assets/01-CLion/27.png)

> 温馨提示：如果选择某个font字体，中文乱码，可以在fallback font（备选字体）中选择一个支持中文的字体。

#### 2、注释的字体颜色

![](assets/01-CLion/28.png)
...
<img src="assets/01-CLion/38.png" alt="" style="zoom:80%;" />

#### 2、已知快捷键，不知道对应的操作名

<img src="assets/01-CLion/39.png" alt="" style="zoom: 70%;" />

### 6.3 自定义快捷键

<img src="assets/01-CLion/40.png" alt="" style="zoom:80%;" />
